...
/**
 * This class provides methods that allow clients to search the Lucene
 * search index.  It also has methods that refresh the IndexSearcher so
 * that recently indexed objects can be found/searched.
 * 
 * @author jkuryla
 */
